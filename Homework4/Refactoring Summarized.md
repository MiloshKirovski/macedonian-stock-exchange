...
**Пред факторирање**: Логиката за пресметување на технички индикатори беше напишана во функцијата `calculate_time_frames` и беше користена низ целиот код.  
...
**По факторирање**: По извршувањето на "resampling" логиката (поделбата на податоците на дневно, неделно и месечно ниво), резултатите сега се ресетираат за да се осигураме дека структурата на DataFrame-от е соодветна за враќање во одговорот. 
